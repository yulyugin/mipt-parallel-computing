...
Можно ли выполниить параллельно?

\pause\bigskip

Зависимости нет $\Rightarrow$ можно выполнить на $\leq$ \texttt{N} потоках.
\end{frame}
...
Можно ли выполнить параллельно?

\pause\bigskip

Антизависимость $\Rightarrow$ можно распараллелить на $\leq$ \texttt{N - 1}.
\end{frame}
...
Истинная зависимость $\Rightarrow$ можно выполнить только в один поток.
\end{frame}
