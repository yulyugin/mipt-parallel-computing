...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \draw[->] (memroot.north west)+(0,0.3cm) -- (memroot.north west);
        ...
        \draw[->] (proc0.north west)+(0,0.3cm) -- (proc0.north west);
        ...
        \draw[->] (proc1.north west)+(0,0.3cm) -- (proc1.north west);
        ...
        \draw[->] (procN.north west)+(0,0.3cm) -- (procN.north west);
