...
\begin{figure}[htp]
    ...
    \begin{tikzpicture}
        ...
        \path[] (1,1) -- (1,-2) node[draw, pos=0.55, sloped, single arrow, text width=0.85cm] {};
        \path[] (3,1) -- (3,-2) node[draw, pos=0.55, sloped, single arrow, text width=0.85cm] {};
        \path[] (5.5,1) -- (5.5,-2) node[draw, pos=0.55, sloped, single arrow, text width=0.85cm] {};
    \end{tikzpicture}
\end{figure}
...
\begin{figure}[htp]
    ...
    \begin{tikzpicture}
        ...
        \path[] (1,-2) -- (1,1) node[draw, pos=0.4, sloped, single arrow, text width=0.85cm] {};
        \path[] (3,-2) -- (3,1) node[draw, pos=0.4, sloped, single arrow, text width=0.85cm] {};
        \path[] (5.5,-2) -- (5.5,1) node[draw, pos=0.4, sloped, single arrow, text width=0.85cm] {};
    \end{tikzpicture}
\end{figure}
