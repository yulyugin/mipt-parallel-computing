...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node[draw, fill=orange, rectangle, right= 4cm of a0, minimum width= 1cm, minimum height= 0.5cm] (a00) {a0};
        \node[draw, fill=orange, rectangle, right= 0cm of a00, minimum width= 1cm, minimum height= 0.5cm] (a10) {a1};
        \node[draw, fill=orange, rectangle, right= 0cm of a10, minimum width= 1cm, minimum height= 0.5cm] (aN0) {aN};
        \node[draw, fill=orange, rectangle, right= 4cm of a1, minimum width= 1cm, minimum height= 0.5cm] (a01) {a0};
        \node[draw, fill=orange, rectangle, right= 0cm of a01, minimum width= 1cm, minimum height= 0.5cm] (a11) {a1};
        \node[draw, fill=orange, rectangle, right= 0cm of a11, minimum width= 1cm, minimum height= 0.5cm] (aN1) {aN};
        \node[draw, fill=orange, rectangle, right= 4cm of aN, minimum width= 1cm, minimum height= 0.5cm] (a0N) {a0};
        \node[draw, fill=orange, rectangle, right= 0cm of a0N, minimum width= 1cm, minimum height= 0.5cm] (a1N) {a1};
        \node[draw, fill=orange, rectangle, right= 0cm of a1N, minimum width= 1cm, minimum height= 0.5cm] (aNN) {aN};
    \end{tikzpicture}
\end{figure}
